...
class ListViewImageWeek<T> extends StatefulWidget {
  ...
  @override
  ListViewImageWeekState<T> createState() => ListViewImageWeekState<T>();
}

class ListViewImageWeekState<T> extends State<ListViewImageWeek<T>> {
  List<T> _data = [];
    ...
    return FutureBuilder<List<T>>(
      ...
      builder: (BuildContext context, AsyncSnapshot<List<T>> snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (_data.isEmpty) {
            return const CustomEmptyListText(
              text: 'empty',
            );
          }
