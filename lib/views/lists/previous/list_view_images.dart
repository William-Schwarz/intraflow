...
class ListViewImagesPrevious<T> extends StatefulWidget {
  ...
  @override
  ListViewImagesPreviousState<T> createState() =>
      ListViewImagesPreviousState<T>();
}

class ListViewImagesPreviousState<T> extends State<ListViewImagesPrevious<T>> {
  @override
  void initState() {
    super.initState();
